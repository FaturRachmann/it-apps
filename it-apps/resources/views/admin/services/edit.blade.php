<x-admin-layout>
    ...
    <div style="max-width: 900px;">
        ...
        <!-- Form Card -->
        <form action="{{ route('admin.services.update', $service) }}" method="POST" style="background: white; border-radius: 20px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); overflow: hidden;">
            @csrf
            @method('PUT')
            ...
            <div style="padding: 32px 40px; border-bottom: 1px solid var(--gray-100); background: linear-gradient(135deg, var(--gray-50) 0%, white 100%);">
                <h2 style="font-size: 1.5rem; font-weight: 800; color: var(--navy-900); margin-bottom: 8px; letter-spacing: -0.02em;">Edit Service</h2>
                <p style="color: var(--gray-500); font-size: 0.9rem;">Update informasi service Anda</p>
            </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 28px;">
                    ...
                    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 24px;">
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $service->title) }}" required placeholder="Masukkan nama service"
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" value="{{ old('slug', $service->slug) }}" placeholder="nama-service"
                    ...
                    <div>
                        ...
                        <textarea name="short_description" id="short_description" rows="2" required placeholder="Deskripsi singkat tentang service ini (1-2 kalimat)"
                            ...
                            onfocus="this.style.borderColor='var(--blue-400)'; this.style.background='white'; this.style.boxShadow='0 0 0 4px rgba(59,130,246,0.1)'"
                            onblur="this.style.borderColor='var(--gray-200)'; this.style.background='var(--gray-50)'; this.style.boxShadow='none'">{{ old('short_description', $service->short_description) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="full_description" id="full_description" rows="8" required placeholder="Deskripsi lengkap tentang service Anda..."
                            ...
                            onfocus="this.style.borderColor='var(--blue-400)'; this.style.background='white'; this.style.boxShadow='0 0 0 4px rgba(59,130,246,0.1)'"
                            onblur="this.style.borderColor='var(--gray-200)'; this.style.background='var(--gray-50)'; this.style.boxShadow='none'">{{ old('full_description', $service->full_description) }}</textarea>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                        <div>
                            ...
                            <input type="text" name="estimated_price" id="estimated_price" value="{{ old('estimated_price', $service->estimated_price) }}" placeholder="Rp 150.000"
                        ...
                        <div>
                            ...
                            <input type="number" name="display_order" id="display_order" value="{{ old('display_order', $service->display_order ?? 1) }}" placeholder="1" min="1"
                                style="width: 100%; padding: 14px 18px; border: 2px solid var(--gray-200); border-radius: 12px; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 1rem; color: var(--gray-800); transition: all 0.2s; outline: none; background: var(--gray-50);"
                                onfocus="this.style.borderColor='var(--blue-400)'; this.style.background='white'; this.style.boxShadow='0 0 0 4px rgba(59,130,246,0.1)'"
                                onblur="this.style.borderColor='var(--gray-200)'; this.style.background='var(--gray-50)'; this.style.boxShadow='none'">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="price_note" id="price_note" value="{{ old('price_note', $service->price_note) }}" placeholder="Harga dapat bervariasi tergantung..."
                            style="width: 100%; padding: 14px 18px; border: 2px solid var(--gray-200); border-radius: 12px; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 1rem; color: var(--gray-800); transition: all 0.2s; outline: none; background: var(--gray-50);"
                            onfocus="this.style.borderColor='var(--blue-400)'; this.style.background='white'; this.style.boxShadow='0 0 0 4px rgba(59,130,246,0.1)'"
                            onblur="this.style.borderColor='var(--gray-200)'; this.style.background='var(--gray-50)'; this.style.boxShadow='none'">
                    ...
                    <div>
                        ...
                        <input type="text" name="icon_url" id="icon_url" value="{{ old('icon_url', $service->icon_url) }}" placeholder="computer, wifi, security, dll"
                            style="width: 100%; padding: 14px 18px; border: 2px solid var(--gray-200); border-radius: 12px; font-family: 'IBM Plex Mono', monospace; font-size: 0.9rem; color: var(--gray-800); transition: all 0.2s; outline: none; background: var(--gray-50);"
                            onfocus="this.style.borderColor='var(--blue-400)'; this.style.background='white'; this.style.boxShadow='0 0 0 4px rgba(59,130,246,0.1)'"
                            onblur="this.style.borderColor='var(--gray-200)'; this.style.background='var(--gray-50)'; this.style.boxShadow='none'">
                    ...
                    <div style="padding: 20px; background: linear-gradient(135deg, var(--gray-50) 0%, white 100%); border-radius: 12px; border: 2px solid var(--gray-200);">
                        <div style="display: flex; align-items: center; gap: 14px;">
                            ...
                            <span style="display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; border-radius: 100px; font-size: 0.75rem; font-weight: 700; {{ old('is_active', $service->is_active) ? 'background: #dcfce7; color: #16a34a;' : 'background: var(--gray-100); color: var(--gray-600);' }}">
                                <span style="width: 8px; height: 8px; border-radius: 50%; {{ old('is_active', $service->is_active) ? 'background: #16a34a;' : 'background: var(--gray-400);' }}"></span>
                                {{ old('is_active', $service->is_active) ? 'Active' : 'Inactive' }}
                            </span>
                        </div>
                    </div>
